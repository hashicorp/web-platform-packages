_This is a forked version of `next-optimized-images` with fixes applied to work with Next.js v11. See below for the applied patch._
...
To install _all_ optional packages, run:
